...
REASON_KOREAN_MAP = {
    ...
    "entry_too_close_to_regular_close": "정규장 마감 임박 신규진입 보류",
    ...
    "session_limit_reached": "세션 검증진입 한도 도달",
    ...
    "no_domestic_candidate": "국내 후보 없음",
    "no_domestic_ready_signal": "국내 진입 준비 신호 없음",
